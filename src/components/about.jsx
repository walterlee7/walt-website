                    ...
                    <div className="typewriter">
                        ...
                        <div className="justify-content-center">
                            <div className="contact">
                                <h1 className="w-style"><span className="panel-shadow contact-span">Contact Info:</span></h1>
                                <h2 className="w-style"><span className="panel-shadow contact-span">walter.lee.developer@gmail.com</span></h2>
                            </div>
                            <div className="contact">
                                <h1 className="w-style"><span className="panel-shadow contact-span">Education:</span></h1>
                                <h2 className="w-style"><span className="panel-shadow contact-span">Vanderbilt University</span></h2>
                                <h2 className="w-style"><span className="panel-shadow contact-span">Bachelor of Science: Neuroscience </span></h2>
                            </div>
                        </div>
