        ...
        return (
            <nav className="navbar navbar-expand-md navbar-light fixed-top" id="mainNav">
                <div className="container">
                    <a className="iconBtn git-icon-style" href="https://github.com/walterlee7" target="_blank" rel="noopener noreferrer">G</a>
                    <a className="iconBtn link-icon-style" href="https://www.linkedin.com/in/walterlee7/" target="_blank" rel="noopener noreferrer">L</a>
